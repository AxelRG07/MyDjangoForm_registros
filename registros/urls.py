...
urlpatterns = [
    ...
    path('equipo/<int:id_equipo>/registrar_jugador', registrar_jugador, name='registrar_jugador'),
    ...
    path('jugador/<int:id_jugador>/actualizar/', actualizar_jugador, name='actualizar_jugador'),
]